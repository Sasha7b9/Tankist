...
cmake src -B%CMAKE_PROJECT_DIR% -DCMAKE_GENERATOR_PLATFORM=x64 -DCMAKE_GENERATOR="Visual Studio 16 2019" -DCMAKE_BUILD_TYPE=%CMAKE_BUILD% -DURHO3D_STATIC_RUNTIME=1
